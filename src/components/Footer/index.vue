...
<template>
<footer class="text-center text-white" style="background-color: #151D48;">
  <div class="container mx-auto px-8 pt-9 md:px-10">
    <p class="text-white font-semibold text-lg font-poppins">Homex.</p>
    <p class="text-white mt-2 font-outfit">
      ...
      <router-link to="/" class="text-white">
        ...
        >
          <path
            ...
            9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7
            67.7-9.9 93.9-36.226.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8
      ...
      <router-link to="/" class="text-white">
        ...
        >
          <path
            ...
            130.274-44.832-46.132-.975-84.792-31.188-98.112-72.7726.498.974
  ...
  <div
  class="text-center text-white p-4 font-poppins"
  style="background-color: rgba(0, 0, 0, 0.2);">
    © 2021 Filon Web Ui Kit
  </div>
</footer>
</template>
