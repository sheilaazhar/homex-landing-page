<template>
  <nav class="
      ...
      mx-auto px-8
      py-4
      lg:flex lg:justify-between lg:items-center md:px-10
    ">
    <div class="flex items-center justify-between">
      <router-link to="/">
        <p class="text-white font-outfit font-bold text-xl md:text-2xl">Homex.</p>
      </router-link>
      <!-- Mobile menu button -->
      <div>
    ...
    <ul :class="showMenu ? 'flex' : 'hidden'" class="
        ...
        lg:mt-0
      ">
      <li class="text-md font-medium font-outfit text-white hover:text-blue-400 cursor-pointer">
        Home
      </li>
      <li class="text-md font-medium font-outfit text-white hover:text-blue-400 cursor-pointer">
        About
